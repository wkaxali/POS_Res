...
<body>
            ...
            <div class="row">
                <div class="col-md-8 ownCardsClass">
                    <div class="card">
                        <div class="myCard">
                            ...
                            <div class="cardImg">
                                <img src="{{asset('app-assets/images/blog3.jpg')}}"
                                    style="height: 70px; width: 70px; border-radius: 10px;" alt="">
                            </div>
                            <div class="cardContent">
                                <h6>Charsi Tikka Lamb</h6><input type="text" value=78 style="display:none" id="PID">
                ...
                <div class="col-md-4">
                    ...
                    <div class="coupon mb-1">
                        ...
                        <input type="text" autocomplete="OFF" name="text" id="myName"><br>
    ...
    <script src="{{asset('assets/css/all.min.css')}}"></script>
    <script>
        £
