...
<head>
    ...
    <style>
        ...
        .card {
            background: rgb(156, 202, 45);
            background: radial-gradient(circle, rgba(156, 202, 45, 1) 19%, rgba(67, 202, 45, 1) 73%);
...
<body>
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-Starter" role="tabpanel"
                    ...
                    <div class="card">
                        <div class="myPare">
                            <div class="item-1">
                                <ul id="MyPage" class="pagination justify-content-end set_quantity">
                                    <li class="page-item">
                                        <button class="page-link " onclick="decreaseNumber('qty','itemval')">
                                    ...
                                    <li class="page-item">
                                        <button class="page-link" onclick="increaseNumber('qty','itemval')"> <i
                                                class="fas fa-plus"></i></button>
                                    </li>
                                </ul>
                                <!-- <h5 id="demo">Charsi Tikka Lamb 1/4Kg</h5> -->
                                <h5>Charsi Tikka Lamb 1/4Kg <input type="text" style="width: 100px;" value="12345" name=""
                                        id="pname"><input type="text" value="45" style="width: 100px;" name=""
                                        id="inp-2"> <input style="width: 100px;" value="13" type="text" name=""
                                        id="inp-3"><input style="width: 100px;" value="39" type="text" name=""
                                        id="inp-4"></h5>
                        ...
                        <div class="modal-dialog modal-md" role="document">
                            <div class="modal-content" id="backgroundC">
                                ...
                                <div class="modal-body"
                                    ...
                                    <table id="cartTable" class="table table-striped text-center "
                                        style="padding: 10px;">
                                        ...
                                        <tbody>
                                        <!-- // here will be code from javascript -->
                    ...
                    <div class="card">
                        <div class="myPare">
                            <div class="item-1">
                                <h5>Charsi Tikka Lamb 1/4Kg</h5>
                                <!-- <h5>Charsi Tikka Lamb 1/4Kg <input type="text" style="width: 100px;" value="4" name=""
                                        id="inp-4"><input type="text" value="4" style="width: 100px;" name=""
                                        id="inp-5"> <input style="width: 100px;" value="6" type="text" name=""
                                        id="inp-6"></h5> -->
                                <p>One of the favourites, succulent pieces of tender and juicy meat infused with
                                    Himalayan rock salt and cooked slowly on red hot natural charcoal.</p>
                            </div>
                            ...
                            <div class="item-4">
                                <button class="btn btn-success" onclick="myOwn()">Add</button>
    ...
    <!-- <script>
        function incrementValue() {
            var ip = document.getElementById("inp-1").value;
            alert(ip);
            var ips = document.getElementById("inp-2").value;
            alert(ips);
            var ipa = document.getElementById("inp-3").value;
            alert(ipa);
            var value = parseInt(document.getElementById('number').value, 10);
            value = isNaN(value) ? 0 : value;
            value++;
            document.getElementById('number').value = value;
            let text = document.getElementById("myId").textContent;
        ...
        function myOwn() {
            var own = document.getElementById("inp-4").value;
            alert(own);
            var owns = document.getElementById("inp-5").value;
            alert(owns);
            var ownss = document.getElementById("inp-6").value;
            alert(ownss);
        }
    </script> -->
    ...
    <script>
        ...
        function addItem(ele) {
           ...
           var pname= pNode.getElementsByTagName("input")[1].value;
           var pid= pNode.getElementsByTagName("input")[2].value;
           var Uprice= pNode.getElementsByTagName("input")[3].value;
          var Tprice=  pNode.getElementsByTagName("input")[4].value;
       ...
       // alert(pname);
        ...
        cell6.innerHTML=pname;

            

            
            // var quantity = document.getElementById("demo").innerText;
            // var Prod = document.getElementById("demo").innerText;
            // var prodPrice = document.getElementById("demo-2").innerText;
            // var updown = document.getElementById("MyPage").querySelectorAll("ul");
            // var ttprice = document.getElementById("demo").innerText;
            // var cancel = document.getElementById("demo").innerText;

            // var table = document.getElementById("cartsTables");
            // var row = table.insertRow(-1);
            // var cell1 = row.insertCell(0);
            // var cell2 = row.insertCell(1);
            // var cell3 = row.insertCell(2);
            ...
            // cell4.innerHTML = updown;
            // cell5.innerHTML = ttprice;
