...
<body>
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-Starter" role="tabpanel"
                    ...
                    <div class="card">
                        <div class="myPare">
                            <div class="item-1">
                                <h5>Charsi Tikka Lamb 1/4Kg <input type="text" style="width: 100px;" value="1" name=""
                                        id="inp-1"><input type="text" value="2" style="width: 100px;" name=""
                                        id="inp-2"> <input style="width: 100px;" value="3" type="text" name=""
                                        id="inp-3"></h5>
                            ...
                            <div class="item-4">
                                <button class="btn btn-success" onclick="incrementValue()"
                                    value="Increment Value">Add</button>
                                                ...
                                                <td>
                                                    ...
                                                    <ul class="pagination justify-content-center set_quantity">
                                                        ...
                                                        <li class="page-item"><input type="text"
                                                                style="border: none !important;" name=""
    ...
    <script>
        ...
        const increaseNumber = (incdec, itemprice) => {
            ...
            var rayan = document.getElementById("textbox").value;
           // alert(rayan);
        }
    </script>
    <script>
