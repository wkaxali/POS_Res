...
<body>
            ...
            <div class="row">
                <div class="col-md-8 ownCardsClass">
                    <div class="card">
                        <div class="myCard">
                            ...
                            <div class="cardContent">
                                <h6>Charsi Tikka Lamb</h6><input type="text" value=78 style="display:none" id="lambPID">
                            ...
                            <div class="cardPricing">
                                <span> <strong class="itemPrice"><dollar> </dollar>13.99</strong> </span>
                    ...
                    <div class="card">
                        <div class="myCard">
                            ...
                            <div class="cardContent">
                                <h6>Charsi Lamb Chops</h6><input type="text" value=88 style="display:none" id="ChopsPID">
                                <p>A fine selection of tender lamb chops, sprinkled barbecue grill.</p>
                            </div>
                            <div class="cardButtons">
                                <ul class="pagination justify-content-end set_quantity">
                    ...
                    <div class="card">
                        <div class="myCard">
                            ...
                            <div class="cardContent">
                                <h6>Charsi Tikka Chicken</h6><input type="text" value=98 style="display:none" id="tikaPID">
                                <p>A fine selection of tender lamb chops, sprinkled barbecue grill.</p>
                            </div>
                            <div class="cardButtons">
                                <ul class="pagination justify-content-end set_quantity">
                    ...
                    <div class="card">
                        <div class="myCard">
                            ...
                            <div class="cardContent">
                                <h6>Landi Kotal Mix Grill<input type="text" value=69 style="display:none" id="kotalPID">
                                </h6>
                                <p>A fine selection of tender lamb chops, sprinkled barbecue grill.</p>
                            </div>
                            <div class="cardButtons">
                    ...
                    <div class="card">
                        <div class="myCard">
                            ...
                            <div class="cardContent">
                                <h6>BBQ Lamb Ribs</h6><input type="text" value=38 style="display:none" id="RibPID">
                                <p>A fine selection of tender lamb chops, sprinkled barbecue grill.</p>
                            </div>
                            <div class="cardButtons">
                                <ul class="pagination justify-content-end set_quantity">
                ...
                <div class="col-md-4">
                    ...
                    <div class="coupon mb-1">
                        ...
                        <input type="text" autocomplete="OFF" name="text" id="customerName"><br>
                        <label for="name">Address</label>
                        <input type="text" autocomplete="OFF" name="text" id="customeradd"><br>
                        <label for="name">Contact</label>
                        <input type="text" autocomplete="OFF" name="text" id="customercontact"><br>

                    </div>
                    <div class="checkOut mb-1">
                        <button class="btn  w-100" id="chekOUT" onclick="Addcustomer()">Checkout</button>
                    </div>
    ...
    <script>
        ...
        var CustomerName=document.getElementById("customerName").value;
            ...
            var CustomerAdd=document.getElementById("customeradd").value;
		   //alert("It is working   "+CustomerAdd);

            var CustomerCon=document.getElementById("customercontact").value;
		   // alert("It is working   "+CustomerCon);

            var Customer = [CustomerName,CustomerAdd,CustomerCon];
...
xhttp.open("GET", "./customerinfo/"+EC, true);
xhttp.send();
...
var saleinvoice=document.getElementById("customerName").text;
  //  alert("It is working   "+saleinvoice);


    var CustomerAdd=document.getElementById("customeradd").text;
  // alert("It is working   "+CustomerAdd);

    var CustomerCon=document.getElementById("customercontact").text;
    //alert("It is working   "+CustomerCon);
...
var EC=JSON.stringify(Customer);
xhttp.open("GET", "./orderreview/"+EC, true);
xhttp.send();
};
