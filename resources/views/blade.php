...
<head>
    ...
    overflow: hidden;
        ...
        .catBtn {
            ...
            display: inline-block;
            font-size: 16px;
            -webkit-box-shadow: 32px 29px 48px -8px rgba(0,0,0,1);
-moz-box-shadow: 32px 29px 48px -8px rgba(0,0,0,1);
box-shadow: 32px 29px 48px -8px rgba(0,0,0,1);
        }
...
<body id="kt_bodys" onload="getCategories()">
    ...
    function addCustomer() {
        ...
        var newCustomer = [customerName, address, contact, cnic, refID, rank];
    ...
    function getCategories() {
        ...
        xhttp.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
                ...
                $.each(a, function (i, item) {
                    table=table+'<tr style="text-align: center"><button class="catBtn" onclick="showMenu(' + a[i].PCID + ')">'+a[i].CategoryName+'</button></tr>';
                    });
        ...
        xhttp.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
                ...
                $.each(a, function (i, item) {
                    ...
                    table=table+'<tr ><button class="productBtn" onclick="addProduct('+PID+', \''+ pName + '\', '+salePrice+')">'+a[i].ProductName+'<br>'+a[i].PerUnitSalePrice+'&#163</button>&nbsp</tr>';
                    });
